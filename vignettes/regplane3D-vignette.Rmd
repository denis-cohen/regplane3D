...
We then generate sequences of 21 equally spaced values for each
...
Estimation and prediction are now a bit more intricate as in the previous
example. Here, we interact both model
...
21 values ranging from `min(centered_approval)` up to the cut point of
